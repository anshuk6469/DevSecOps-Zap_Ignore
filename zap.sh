...
docker run -v $(pwd)/zap-report:/zap/wrk/:rw -t quay.io/anshuk6469/owaspzap-report zap-api-scan.py -t $applicationURL:$PORT/v3/api-docs -f openapi -c zap_rules -r zap_report.html
